...
class Form extends React.Component {
    ...
    this.state = {
      ...
      offersTable: [
        {
          ...
          type: "Promotional",
          offerName:
            "Internet (44) SPP 2.0 #2753393 NC",
          price: "$44.99",
          showCart: true
        },
        {
          ...
          type: "Promotional",
          offerName:
            "TV Select (44) SPP 2.0 #2752943 NC",
          price: "$44.99",
          showCart: true
        },
        {
          ...
          type: "Promotional",
          offerName:
            "2 Yr Internet - Competitive/Gig Escalation (44) SPP 2.0 #2773863 NC",
          price: "$64.99",
          showCart: true
        }
      ],
      ...
      doublePlay: [
        ...
        },
        {
          ...
          type: "Promotional",
          offerName:
            "Limited Basic + Internet (23/39) SPP #397223 NC",
          price: "$63.88",
          showCart: true
        },
        {
          ...
          id: 6,
          type: "Promotional",
          offerName: "2 Yr TV Select + Internet Plus w/Free or Discounted DVR Svc Escalation (39/39) SPP #407371 NC",
          price: "$79.98",
          showCart: true
        },
        {
          ...
          id: 7,
          type: "Promotional",
          offerName: "2 Yr TV Select + Internet Ultra - Competitive/Gig Escalation (39/39) SPP 2.0 #2775773 NC",
          price: "$79.98",
          showCart: true
        },
        {
          ...
          id: 8,
          type: "Promotional",
          offerName: "2 Yr TV Select + Internet Ultra - Competitive/Non-Gig Escalation (39/59) SPP 2.0 #2778543 NC",
          price: "$99.98",
          showCart: true
        },
      ...
      addOn: [
        {
          ...
          type: "AddOn",
          offerName:
            "Voice Bundled (9) SPP 2.0 #2755393 NC",
          price: "$9.99",
          showCart: true
        },
        {
    ...
    switch (fieldName) {
      case "firstname":
        fieldValidationErrors.firstname =
          this.state.firstname.length === 0 ? true : false;
        break;
      case "lastname":
        fieldValidationErrors.lastname =
          this.state.lastname.length === 0 ? true : false;
        break;
      case "primaryphone":
        fieldValidationErrors.primaryphone =
          this.state.primaryphone.length === 0 ? true : false;
        if (this.state.primaryphone.length === 0) {
          ...
          this.state.landlinePhone.map(item => {
            if ((value === "3145893658" || value === '3147589604' || value === '6423658962') && item.type === "landline") {
              this.setState({
                isMobile: false,
                activeNumber: false,
  ...
  handleRowChecked = e => {
    if (e.target.checked) {
      ...
      let filteredArray = this.state.selectedOffers.filter(
                      ...
                      <div>
                                ...
                                <div>
                                  <div className="row">
                                    ...
                                    <div className="col-md-3 col-xs-12">
                                      ...
                                      <label>Primary Phone:<Tooltip title="Please ensure you capture the customer's Mobile number as their primary telephone number."><span className="fa fa-question-circle fa-lg"></span></Tooltip></label>
                                        <input
                                           type="tel"
                                           pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"
                                           id="primaryphone"
                                           className={`form-control ${this.state.errors.primaryphone
                                               ? "error"
                                               : ""
                                           }`}
                                           name="primaryphone"
                       ...
                       {/* <div className="input-group-append"> */}
                                          ...
                                          <ReactTooltip place="top" type="dark" effect="float"/>
                                           ...
                                           {this.state.isMobile && <i data-tip={this.state.tooltiptext} className={`fa fa-mobile ${this.state.activeNumber?'activeNumberClass':''}`}/>}
                                           {!this.state.isMobile && <i data-tip={this.state.tooltiptext} className="fa fa-phone"></i>}
                                           {!this.state.isMobile && <i data-tip={this.state.tooltiptext} className="fa fa-info-circle errspan"></i>}
                                          </span>
                                       {/* </div> */}
                                      </div>
                                    </div>
                                      ...
                                      <tbody>
                                        {this.state.selectedOffers.map(
                                          offer => {
                                            return (
                                              <tr key={offer.id}>
                                                <td><img src={RedX} alt="redcross" onClick={() => this.removeSelectedOffers(offer)} className="fa fa-times-circle" /></td>
                                    ...
                                    <div className="col-xs-12">
                                      <div className="table-responsive">
                                        <table className="table-striped-manual table table-striped table-bordered table-condensed">
                                          ...
                                          <tbody>
                                            {this.state.offersTable.map(
                                              offer => {
                                                return (
                                                  <tr key={offer.id}>
                                                    <td>

                                                      {offer.showCart && <img src={Shopping_Cart} alt="shopping_cart" onClick={() => this.addOffer(offer)} className="fas fa-cart-plus" />}
                                                      {!offer.showCart && <img src={Green_Checkmark} alt="greencheck" />}
                                                    </td>
                                                    {/* <td>
                                                      <input
                                                        name={offer.id}
                    ...
                    <div className="form-group form-group-style" >
                        ...
                        <div className="multiselectComponent">
                            <div className="dropdown">
                                ...
                                -- Please Select --<span className="caret"></span>
                                </button>
                  ...
                  <div className="panel-body">
                    <nav className="collapse in" dimension="height">
                      <ul className="nav nav-pills nav-justified">
                        <li
                          className={`offerHeader ${this.state.currentTab === "offerHeader" && "active"}`}
                          role="presentation"
                          id="offerHeader"
                        ...
                        {this.state.tabsInView.includes("basicServices") && 
                          <li
                          className={`offerHeader ${this.state.currentTab === "basicServices" && "active"}`}
                          role="presentation"
                          id="basicServices"
                          onClick={this.handleNavClick}
                        >
                    ...
                    <div className="buttonGroupRight">
                      ...
                      <button onClick={this.handleNextBtnClick} className="btn btn-success" type="button">Next</button>
                    </div>
                  </div>
                </div>
              </div>
