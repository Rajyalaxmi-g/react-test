      ...
      case "primaryphone":
        ...
        if (this.state.primaryphone.length === 0) {
          ...
          for (var i = 0; i < this.state.phonesArray.length; i++) {
            ...
            if ((this.state.primaryphone === this.state.phonesArray[i].phone && this.state.phonesArray[i].type === "mobile")) {
              ...
              fieldValidationErrors.primaryphone = false;
       break
            } else if(this.state.primaryphone === this.state.phonesArray[i].phone  && this.state.phonesArray[i].type === "landline") {
              this.setState({ activeNumber: false, tooltiptext: "This is landline number. Please try and get the customer's mobile number",ppIcon:this.state.phonesArray[i].icon });
              fieldValidationErrors.primaryphone = false;
              break
            }else{
              console.log("invalid")
              fieldValidationErrors.primaryphone = true;
              this.setState({ activeNumber: false, tooltiptext: "The phone number entered is invalid!",ppIcon:'fa fa-times-circle' });
            }
          };
                                ...
                                <span className="input-group-text">
                                  <ReactTooltip place="top" type="dark" effect="float"/>
                                     ...
                                     <i
                                      ...
                                      className={`${this.state.ppIcon}  ${this.state.activeNumber? "activeNumberClass":''}`}
                                    />
          ...
          <div className="form-group">
            ...
            <div >
              <div>
                ...
                {<div>Host Phone: {this.state.number} 
                ...
                <div className="tab-col modal-container panel panel-default">
                  <div className="panel-body">
                    ...
                    <div className="buttonGroupLeft">
                      ...
                      <button
                        className="clearOrder btn btn-default"
                        type="button"
                      >
                        Clear Order
                      </button>
